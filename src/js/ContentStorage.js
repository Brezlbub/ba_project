...
ChromeExtensionURUT.ContentStorage = function() {
  ...
  function init() {
    ...
    demographic = {id: 3, stepBack: 0, stepNext: 1, isTask: 0, title: "Demographischer Fragebogen", content: "blabla"};

    szenario1 = {id: 4, stepBack: 0, stepNext: 1, isTask: 0, title: "Hintergrundszenario 1", content: "Sie wollen sich mal wieder kulturell bereichern. Ihnen wurde das Statt Theater empfohlen, da diese eine Vielzahl unterschiedlicher Veranstaltungen bieten soll. Sie wollen sich nun auf deren Webseite über die anstehenden Events etc. informieren."};
    sz1task1 = {id: 5, stepBack: 0, stepNext: 0, isTask: 1, title: "Task 1", content: "Schauen Sie sich zunächst auf der Seite um und beschreiben Sie ihren ersten Eindruck. "};
    ...
    abschluss1 = {id: 12, stepBack: 0, stepNext: 0, isTask: 0, title: "Beschreibung 1", content: "Beschreiben Sie kurz was Ihnen nach der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. Was… fanden Sie schlecht?"};
    abschluss2 = {id: 13, stepBack: 0, stepNext: 0, isTask: 0, title: "Beschreibung 2", content: "Beschreiben Sie kurz was Ihnen nach der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. Was… fanden Sie gut?"};
    abschluss3 = {id: 14, stepBack: 0, stepNext: 1, isTask: 0, title: "Beschreibung 3", content: "Beschreiben Sie kurz was Ihnen nach der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. Was… würden Sie verbessern?"};
