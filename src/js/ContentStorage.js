...
ChromeExtensionURUT.ContentStorage = function() {
  ...
  function init() {
    ...
    content: "Beschreiben Sie kurz was Ihnen <b>nach</b> der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. </br></br>Was fanden Sie <b>schlecht</b>?</br></br>Mehrere Antworten möglich."};
    question2 = {id: 12, stepBack: 1, stepNext: 1, isTask: 0, title: "Beschreibung 2",
    content: "Beschreiben Sie kurz was Ihnen <b>nach</b> der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. </br></br>Was fanden Sie <b>gut</b>?</b></br></br>Mehrere Antworten möglich."};
    question3 = {id: 13, stepBack: 1, stepNext: 1, isTask: 0, title: "Beschreibung 3",
    content: "Beschreiben Sie kurz was Ihnen <b>nach</b> der Bearbeitung der Aufgaben besonders an der Seite aufgefallen ist. </br></br>Was würden Sie <b>verbessern</b>?</b></br></br>Mehrere Antworten möglich."};
    ...
    content: "Zum Abschluss drücken Sie bitte auf den 'DOWNLOAD' Butto.</br>Danach wird eine Datei runtergeladen. Diese bitte an folgende E-Mail als Anhang schicken: </br></br> Julian.Saenze@stud.uni-regensburg.de</br></br>Herzlichen Dank für die Teilnahme an meiner Studie!"};
